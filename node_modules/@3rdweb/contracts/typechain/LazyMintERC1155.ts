...
export interface LazyMintERC1155Interface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, ClaimConditionStruct[]]
  ): string;
  encodeFunctionData(
...
export type NewClaimConditionsEvent = TypedEvent<
  [BigNumber, ClaimConditionStructOutput[]],
  { tokenId: BigNumber; claimConditions: ClaimConditionStructOutput[] }
>;
...
export interface LazyMintERC1155 extends BaseContract {
  ...
  filters: {
    ...
    "ClaimedTokens(uint256,uint256,address,uint256)"(
    ...
    "NewClaimConditions(uint256,tuple[])"(
      tokenId?: BigNumberish | null,
