...
export interface SplitsInterface extends utils.Interface {
    functions: {
        ...
        "initialize(address,string,address[],uint256[])": FunctionFragment;
...
export interface Splits extends BaseContract {
    ...
    functions: {
        ...
        initialize(_trustedForwarder: string, _uri: string, payees: string[], shares_: BigNumberish[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        hasRole(role: BytesLike, account: string, overrides?: CallOverrides): Promise<boolean>;
        initialize(_trustedForwarder: string, _uri: string, payees: string[], shares_: BigNumberish[], overrides?: CallOverrides): Promise<void>;
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
