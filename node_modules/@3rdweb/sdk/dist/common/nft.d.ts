import { LazyMintERC1155, LazyMintERC721, LazyNFT, NFT, NFTCollection } from "@3rdweb/contracts";
 ...
 * @internal
 */
export declare type NFTContractTypes = NFT | NFTCollection | LazyNFT | LazyMintERC721 | LazyMintERC1155;
/**
/* @internal
 */
...
/* @internal
 */
export declare function getTokenMetadata(contract: NFTContractTypes, tokenId: string, ipfsGatewayUrl: string): Promise<NFTMetadata>;
