...
import { SnapshotInfo } from "../types/snapshots";
import { IAppModule, RegistryModule } from "./registry";
import { MetadataURIOrObject, ProviderOrSigner, ValidProviderInput } from "./types";
/**
 * @internal
 */
export declare type AnyContract = typeof AppModule | typeof BundleModule | typeof NFTModule | typeof CurrencyModule | typeof MarketModule | typeof PackModule | typeof RegistryModule | typeof DropModule | typeof DatastoreModule | typeof SplitsModule | typeof BundleDropModule | typeof MarketplaceModule | typeof VoteModule;
/**
